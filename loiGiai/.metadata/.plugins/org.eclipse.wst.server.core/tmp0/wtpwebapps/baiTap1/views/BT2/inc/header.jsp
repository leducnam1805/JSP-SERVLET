...
<link href="<%=request.getContextPath()%>/views/BT2/css/style.css"
			...
			<div class="container_12">
				<div class="grid_12">
					<div id="logo">
						<ul id="nav">
							<li id="current"><a
								href="<%=request.getContextPath()%>/views/BT2/index.jsp">Quản
									trị</a></li>
							<li><a
								href="<%=request.getContextPath()%>/views/BT2/taikhoan.jsp">Tài
									khoản</a></li>
						</ul>
					</div>
					<!-- End. #Logo -->
