<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@include file="/views/BT3/inc/header.jsp"%>
<div id="main-body">
	<div class="main-content">
		<%@ include file="/views/BT3/inc/leftmenu.jsp"%>
		<div class="body-right fr">
			<div class="news-block">
				<h2 class="title-cat">
					<a href="danhmuc.jsp" title="Toàn cảnh Nhật Bản">Toàn cảnh Nhật
						Bản</a>
				</h2>
				<div class="content-cat">
					...
					<div class="item-right fr">
						<ul>
							...
							<li><a
								href="/Nhung-bao-tang-co-mot-khong-hai-o-Nhat-Ban-a216.jsp"
			...
			<div class="news-block">
				...
				<div class="content-cat">
					...
					<div class="item-right fr">
						<ul>
							<li><a href="/Dau-an-huu-nghi-Ha-Noi-Fukuoka-a223.jsp"
							...
							<li><a
								href="/Cai-cach-de-thu-hut-von-dau-tu-Nhat-Ban-a222.jsp"
							...
							<li><a href="/Tao-khac-biet-thu-hut-FDI-Nhat-Ban-a221.jsp"
			...
			<div class="news-block">
				...
				<div class="content-cat">
					<div class="item-left fl">
						<a href="/Huyen-thoai-nu-chien-binh-Nhat-Ban-a229.jsp"
							...
							href="/Huyen-thoai-nu-chien-binh-Nhat-Ban-a229.jsp"
					...
					<div class="item-right fr">
						<ul>
							<li><a href="/Tinh-dung-gio-cua-nguoi-Nhat-a228.jsp"
							...
							<li><a href="/Con-so-xui-xeo-cua-nguoi-Nhat-a227.jsp"
							...
							<li><a
								href="/Nhat-Ban-Lao-dong-la-tai-san-quy-gia-nhat-a226.jsp"
			...
			<div class="news-block">
				...
				<div class="content-cat">
					<div class="item-left fl">
						<a href="/Cam-nang-du-hoc-Nhat-Ban-2014-a234.jsp"
					...
					<div class="item-right fr">
						<ul>
							<li><a href="/Du-hoc-Nhat-Ban-nhieu-loi-the-a233.jsp"
							...
							<li><a
								href="/Suy-nghi-cua-du-hoc-sinh-tai-nhat-ve-Homestay-(O-nha-dan)-a232.jsp"
							...
							<li><a
								href="/Du-hoc-Nhat-Ban-va-Tu-nghiep-Nhat-Ban-khac-nhau-nhu-the-nao-a231.jsp"
...
<%@include file="/views/BT3/inc/footer.jsp"%>
