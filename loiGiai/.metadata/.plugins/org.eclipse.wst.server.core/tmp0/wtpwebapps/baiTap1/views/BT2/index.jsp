...
<div class="container_12">
	...
	<div class="grid_main_l">
		<a href="themtintuc.html" class="dashboard-module"> <img
			src="images/Crystal_Clear_write.gif" width="64" height="64"
			alt="edit" /> <span>Thêm tin sản phẩm</span>
		</a> <a href="themtintuc.html" class="dashboard-module"> <img
			src="images/Crystal_Clear_files.gif" width="64" height="64"
